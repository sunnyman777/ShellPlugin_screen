...
//	public static final int GLMENU_ID_FACEBOOK_LIKE_US = 127;
	public static final int GLMENU_ID_PLUGIN_MANAGEMENT = 128; // 插件管理
	public static final int GLMENU_ID_CLEAR_SCREEN = 129;
	public static final int GLMENU_ID_APPCENTER = 130;
	public static final int GLMENU_ID_GAMEZONE = 131;
	public static final int GLMENU_ID_WIN_AWARD = 132;
