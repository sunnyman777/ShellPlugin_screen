 ...
 * dingzijian
 */
public class ScreenFolderPowerSavingModeStatus extends ScreenFolderSilentModeStatus {
	private int mBrightness = -1;
	private boolean mIsAutoBrightness;
	public ScreenFolderPowerSavingModeStatus(GLAppFolderBaseGridView gridView) {
		super(gridView);
	}
