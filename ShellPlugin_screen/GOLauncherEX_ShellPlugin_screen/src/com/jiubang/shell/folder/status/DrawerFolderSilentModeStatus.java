 ...
 *
 */
public class DrawerFolderSilentModeStatus extends DrawerFolderNormalStatus {
	protected int mVolume = -1;

	public DrawerFolderSilentModeStatus(GLAppFolderBaseGridView gridView) {
		super(gridView);
	}
	...
	public boolean onClickUnderStatus(GLAdapterView<?> parent, GLView view, int position, long id) {
		...
		Log.i("dzj", "AppDrawer SilentMode" + succeed);
