...
public class LittleEndianDataInputStream extends FilterInputStream implements
	...
	public int readInt() throws IOException, EOFException {
		int res = 0;
		for (int shiftBy = 0; shiftBy < 32; shiftBy += 8) { // CHECKSTYLE IGNORE
			res |= (this.mDis.readByte() & 0xff) << shiftBy; // CHECKSTYLE IGNORE
		}
		mPosition += 4; // CHECKSTYLE IGNORE
		return res;
	}
	...
	public long readLong() throws IOException, EOFException {
		long res = 0;
		for (int shiftBy = 0; shiftBy < 64; shiftBy += 8) { // CHECKSTYLE IGNORE
			res |= (this.mDis.readByte() & 0xff) << shiftBy; // CHECKSTYLE IGNORE
		}
		mPosition += 8; // CHECKSTYLE IGNORE
		return res;
	}
	...
	public short readShort() throws IOException, EOFException {
		final int low = readByte() & 0xff; // CHECKSTYLE IGNORE
		final int high = readByte() & 0xff; // CHECKSTYLE IGNORE
		mPosition += 2;
		return ( short ) (high << 8 | low); // CHECKSTYLE IGNORE
	}
	...
	public int readUnsignedShort() throws IOException {
		...
		final int high = readByte() & 0xff; // CHECKSTYLE IGNORE
		mPosition += 2;
		return high << 8 | low; // CHECKSTYLE IGNORE
	}
