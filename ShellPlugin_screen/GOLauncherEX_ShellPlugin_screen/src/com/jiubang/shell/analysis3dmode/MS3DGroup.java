...
public class MS3DGroup {
	 ...
	 * @param triangleIndicies
	 *            an array of indicies pointing to a list of triangles stored in
	 *            {@link MS3DTriangle}
	 * @param materialIndex
	 *            points to the material that should be used for this mesh
	 * @param flags
	 *            not used in this release
	 */
	MS3DGroup(final String name, final int[] triangleIndicies,
	        final byte materialIndex, final byte flags) {
		setName(name);
	 ...
	 * 
	 * @param flags
	 *            a byte indicating state (not used in this release)
	 */
	final void setFlags(final byte flags) {
	}

	/**
	 * Retrieve the list of indicies pointing into an array of MS3DTriangles.
	 * These triangles make up the mesh.
	 * 
	...
	/**
	 * Retrieve the index of the material used in this mesh. The material is
	 * stored in a list of {@link MS3DMaterial} objects.
	 * 
	 * @return a byte
	 */
