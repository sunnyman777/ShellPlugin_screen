...
import com.go.util.scroller.ViscousFluidInterpolater;
 ...
 * 
 */
public abstract class ShellMScroller {
	/** 水平滚动方向 */
	...
	private static final float SMOOTHING_CONSTANT = (float) (0.016f / Math.log(SMOOTHING_SPEED));
	...
	protected boolean mFirstSmooth;
	protected boolean mScrollComputed;
	...
	ShellMScroller(Context context) {
		if (context != null) {
