...
abstract class MGridScreenEffector {
	...
	static final float RIGHT_ANGLE = 90f;
	static final int FADE_ANGLE = 75;
	static final float INTERPOLATE_END = 64f;
	...
	public void onAttach(GridScreenContainer container, ShellScreenScroller scroller) {
	...
	abstract void onDrawScreen(GLCanvas canvas, int screen, int offset);
	...
	void drawScreen(GLCanvas canvas, int screen, int offset, int topPadding, int scroll) {
		if (screen == ShellScreenScroller.INVALID_SCREEN) {
			return;
		}
		canvas.save();
	...
	static void drawScreen(GridScreenContainer container, GLCanvas canvas, ShellScreenScroller scroller,
...
//		final int height = scroller.getScreenHeight();
	 ...
	 * @param scroll
	 */
	static void drawScreenBackground(GridScreenContainer container, GLCanvas canvas, int screen,
