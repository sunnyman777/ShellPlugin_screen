 ...
 *
 */
public class GLGoShortCutAdapter extends ShellBaseAdapter<Object> {

	public GLGoShortCutAdapter(Context context, List<Object> infoList) {
	...
	public GLView getView(int position, GLView convertView, GLViewGroup parent) {
		...
		ShortCutInfo item = (ShortCutInfo) mInfoList.get(position);
		if (item == null) {
			return view;
		}
